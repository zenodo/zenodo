...
class Template:
    ...
    def tmpl_form(self, publicationid, projectid, projects_information, publication_information, fulltext_information, form=None, metadata_status='empty', warnings=None, errors=None, ln=CFG_SITE_LANG):
        ...
        values['volume_tooltip'] = escape(_("The volume part of the publication information, which is typical a number."))
        values['issue_label'] = escape(_("Issue"))
        values['issue_tooltip'] = escape(_("The issue part of the publication information, which is typical a number."))
        values['pages_label'] = escape(_("Pages"))
        values['pages_tooltip'] = escape(_("The pages part of the publication information, which is typical a range of number of the form <pre>123-456</pre>."))
