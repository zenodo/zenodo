...
<div class="well">
    ...
    <a href="{{ bfe_server_info(bfo, var='CFG_SITE_URL') }}{{ bfe_server_info(bfo, var='CFG_SITE_RECORD') }}/{{ bfe_record_id(bfo, ) }}/export/dcite3?ln={{ bfe_client_info(bfo, var='ln') }}">DataCite</a>,
